<nav class="sidebar-nav">
    <ul>
        ...
        @if (Auth::user()->isSupport() || Auth::user()->isAdmin() || Auth::user()->isAccount())
        ...
        @endif
        @if (Auth::user()->isChefGuerite() || Auth::user()->isAdmin())
            <li class="nav-item {{ Request::is('refund') ? 'active' : '' }} ">
                <a href="{{ route('refund') }}">
                    <span class="icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="text">Mes remboursements</span>
                </a>
            </li>
        @endif
        ...
        @if (Auth::user()->isChefGuerite() ||
            ...
            <li class="nav-item {{ Request::is('payback/index') ? 'active' : '' }} ">
                <a href="{{ route('payback.index') }}">
                    ...
                    <span class="text">Remboursement</span>
                </a>
            </li>
        @endif
        ...
        @if (Auth::user()->isAdmin() )
            <li class="nav-item {{ Request::is('report-create') ? 'active' : '' }} ">
                <a href="{{ route('reporting.create') }}">
                    ...
                    <span class="text">Rédiger son rapport</span>
                </a>
            </li>
        @endif
        ...
        @if (Auth::user()->isAdmin() )
            <li class="nav-item {{ Request::is('report-index') ? 'active' : '' }} ">
                <a href="{{ route('reporting.index') }}">
                    ...
                    <span class="text">Consulter un rapport</span>
                </a>
            </li>
        @endif
        ...
        @if (Auth::user()->isAdmin() ||
            Auth::user()->isSupport() ||
            Auth::user()->isAdministration())
            <li class="nav-item {{ Request::is('prediction') ? 'active' : '' }} ">
        ...
        @if (Auth::user()->isAdmin() || Auth::user()->isSupport())
            <li class="nav-item {{ Request::is('all-predictiond') ? 'active' : '' }} ">
                <a href="{{ route('prediction.index') }}">
                    ...
                    <span class="text">Prévisions</span>
                </a>
            </li>
        @endif
        ...
        @if (Auth::user()->isAdmin() ||  Auth::user()->isAdministration() || Auth::user()->isChefGuerite() || Auth::user()->isSupport() )
            <li class="nav-item {{ Request::is('search/container') ? 'active' : '' }} ">
                <a href="{{ route('search.container') }}">
                    ...
                    <span class="text">Apurement</span>
                </a>
            </li>
        @endif

        @if (Auth::user()->isAdmin() || Auth::user()->isOperateur() ||  Auth::user()->isAdministration() || Auth::user()->isChefGuerite())
            <li class="nav-item {{ Request::is('checkpoint/index') ? 'active' : '' }}">
                <a href="{{ url('checkpoint/index') }}">
                    ...
                    <span class="text">Contrôle camion</span>
                </a>
            </li>
        @endif
        ...
        @if (Auth::user()->isAdmin())
            <li class="nav-item {{ Request::is('signature/index') ? 'active' : '' }} ">
        ...
        @if (Auth::user()->isAdmin())
            <li class="nav-item" {{ Request::is('logs') ? 'active' : '' }} ">
              <a target="_blank" href="{{ route('log') }}">
          <span class="icon">
              <svg
                  width="22"
                  height="22"
              ...
              >
                ...
                />
                  ...
                  <span class="text">Journal d'erreur</span>
              </a>
          </li>
 @endif
